      ...
      firebase
        ...
        .then((response) => {
          ...
          if (!response.user.emailVerified) {
            toast.warning("Para poder loguearte debes verificar la cuenta");
          }
        })
        .catch((err) => {
    ...
    <div className="login-form">
      ...
      <Form onSubmit={onSubmit} onChange={onChange}>
        ...
        <Form.Field>
          ...
          {formError.password && (
            <span className="error-text">
              Por favor, elige una contraseña mayor a 5 caracteres.
            </span>
          )}
        </Form.Field>
...
function ButtonResetSendEmailVerification(props) {
  ...
  return (
    <div className="resend-verification-email">
      <p>
        Si necesitas reenviar el correo de verificacion, haz click{" "}
